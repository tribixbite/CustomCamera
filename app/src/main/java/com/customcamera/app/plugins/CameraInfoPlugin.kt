...
class CameraInfoPlugin : ProcessingPlugin() {
    ...
    override val displayName: String = "Camera Info"
    override val description: String = "Real-time camera information display"
    ...
    companion object : com.customcamera.app.engine.plugins.PluginProvider {
        ...
        override val id: String = "camera_info"

        override val displayNameRes: Int = com.customcamera.app.R.string.plugin_camera_info_display_name

        override val descriptionRes: Int = com.customcamera.app.R.string.plugin_camera_info_description
