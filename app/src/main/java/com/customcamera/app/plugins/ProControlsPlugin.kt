...
class ProControlsPlugin : ControlPlugin() {
    ...
    companion object : com.customcamera.app.engine.plugins.PluginProvider {
        ...
        override val id: String = "pro_controls"

        override val displayNameRes: Int = com.customcamera.app.R.string.plugin_pro_controls_display_name
