...
class MotionDetectionPlugin : ProcessingPlugin() {
    ...
    companion object : com.customcamera.app.engine.plugins.PluginProvider {
        ...
        override val id: String = "motion_detection"

        override val displayNameRes: Int = com.customcamera.app.R.string.plugin_motion_detection_display_name

        override val descriptionRes: Int = com.customcamera.app.R.string.plugin_motion_detection_description
