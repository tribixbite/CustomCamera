...
class NightModePlugin : ProcessingPlugin() {
    ...
    companion object : com.customcamera.app.engine.plugins.PluginProvider {
        ...
        override val id: String = "night_mode"

        override val displayNameRes: Int = com.customcamera.app.R.string.plugin_night_mode_display_name

        override val descriptionRes: Int = com.customcamera.app.R.string.plugin_night_mode_description
