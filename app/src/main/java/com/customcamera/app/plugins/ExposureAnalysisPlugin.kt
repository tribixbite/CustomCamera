...
class ExposureAnalysisPlugin : ProcessingPlugin() {
    ...
    companion object : com.customcamera.app.engine.plugins.PluginProvider {
        ...
        override val id: String = "exposure_analysis"

        override val displayNameRes: Int = com.customcamera.app.R.string.plugin_exposure_analysis_display_name

        override val descriptionRes: Int = com.customcamera.app.R.string.plugin_exposure_analysis_description
