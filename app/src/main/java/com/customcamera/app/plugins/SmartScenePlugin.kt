...
class SmartScenePlugin : ProcessingPlugin() {
    ...
    companion object : com.customcamera.app.engine.plugins.PluginProvider {
        ...
        override val id: String = "smart_scene"

        override val displayNameRes: Int = com.customcamera.app.R.string.plugin_smart_scene_display_name

        override val descriptionRes: Int = com.customcamera.app.R.string.plugin_smart_scene_description
        ...
        override fun isSupported(context: android.content.Context): Boolean {
            return try {
                // ML Kit Image Labeling requires Google Play Services
                val packageManager = context.packageManager
                packageManager.getPackageInfo("com.google.android.gms", 0)
                true
            } catch (e: Exception) {
                android.util.Log.w(TAG, "Google Play Services not available for ML Kit Image Labeling", e)
                false
            }
        }
